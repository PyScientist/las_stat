...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def run_program(self):
        ...
        print u'Путь к папке с данными для обработки', folder_name
        print u'Путь к файлу отчета о наличии файлов', report_file
        print u'Путь к файлу результатов статистики', results_file
